...
import aiDraftRoutes from "./routes/aiDraft.js";
import aiAuditRoutes from "./routes/aiAudit.js";
import clinicalProfileRoutes from "./routes/clinicalProfile.js";
...
app.use(clinicalProfileRoutes);
app.use(aiAuditRoutes);
app.use(aiDraftRoutes);
