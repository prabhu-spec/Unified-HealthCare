...
const FEATURES = [
  ...
  { id: "ai_assist", label: "AI Assist + structured patient context", api: "/api/core/patients/:id/ai-context", phase: 8, roles: ["doctor", "nurse", "hospital_admin", "super_admin", "patient"], done: true },
  { id: "ai_clinical_profile", label: "Editable clinical profile for AI", api: "/api/core/patients/:id/clinical-profile", phase: 8, roles: ["doctor", "nurse", "hospital_admin", "super_admin"], done: true },
  { id: "ai_audit", label: "AI Assist audit log", api: "/api/ai-audit", phase: 8, roles: ["hospital_admin", "super_admin"], done: true },
  { id: "ai_accept_draft", label: "Accept AI draft to consult notes", api: "/api/core/patients/:id/accept-ai-draft", phase: 8, roles: ["doctor", "nurse", "hospital_admin", "super_admin"], done: true },
];
