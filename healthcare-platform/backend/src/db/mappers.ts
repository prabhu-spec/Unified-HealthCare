...
export function patientToApi(p: Patient) {
  return {
    ...
    ...patientClinicalFields(p),
  };
}

export function patientClinicalFields(p: Patient) {
  return {
    weightKg: p.weightKg ?? undefined,
    heightCm: p.heightCm ?? undefined,
    bloodType: p.bloodType ?? undefined,
    chiefComplaint: p.chiefComplaint ?? undefined,
    pregnancyStatus: p.pregnancyStatus ?? undefined,
    eGFR: p.eGFR ?? undefined,
    creatinine: p.creatinine ?? undefined,
    smokingStatus: p.smokingStatus ?? undefined,
    alcoholUse: p.alcoholUse ?? undefined,
    codeStatus: p.codeStatus ?? undefined,
  };
}
