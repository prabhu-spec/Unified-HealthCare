...
/** Mock appointments: used for hospital-scoped filtering (hospital admin / doctor see only their hospital). */
export const MOCK_APPOINTMENTS = [
  { id: 'apt-1', patientId: 'patient-1', hospitalId: 'org-1', doctorName: 'Dr. Sarah Johnson', doctorType: 'general', date: '2025-03-10', time: '10:00', status: 'scheduled' },
  { id: 'apt-2', patientId: 'patient-2', hospitalId: 'org-1', doctorName: 'Dr. Sarah Johnson', doctorType: 'general', date: '2025-03-11', time: '14:30', status: 'scheduled' },
  { id: 'apt-3', patientId: 'patient-1', hospitalId: 'org-2', doctorName: 'Dr. Murray Baker', doctorType: 'ortho', date: '2025-03-15', time: '09:00', status: 'completed' },
  { id: 'apt-4', patientId: 'patient-3', hospitalId: 'org-1', doctorName: 'Dr. Sarah Johnson', doctorType: 'general', date: '2025-03-12', time: '11:00', status: 'scheduled' },
  { id: 'apt-5', patientId: 'patient-4', hospitalId: 'org-2', doctorName: 'Dr. Murray Baker', doctorType: 'ortho', date: '2025-03-14', time: '09:30', status: 'completed' },
];

/** Patient IDs that have at least one appointment at the given hospital (for hospital-scoped views). */
export function getPatientIdsForHospital(hospitalId: string): Set<string> {
  if (!hospitalId) return new Set();
  return new Set(MOCK_APPOINTMENTS.filter((a) => a.hospitalId === hospitalId).map((a) => a.patientId));
}