...
export async function seedDatabase(): Promise<void> {
  ...
  await prisma.$transaction([
    ...
    prisma.patient.createMany({
      data: [
        { id: "patient-1", hospitalId: "org-1", firstName: "John", lastName: "Smith", gender: "male", birthDate: "1985-03-15", mrn: "MRN123456", phone: "+1-555-0123", email: "john.smith@email.com", street: "123 Main St", city: "Springfield", state: "IL", postalCode: "62701" },
        { id: "patient-2", hospitalId: "org-1", firstName: "Sarah", lastName: "Johnson", gender: "female", birthDate: "1992-07-22", mrn: "MRN789012", phone: "+1-555-0456", email: "sarah.johnson@email.com", street: "456 Oak Ave", city: "Springfield", state: "IL", postalCode: "62702" },
